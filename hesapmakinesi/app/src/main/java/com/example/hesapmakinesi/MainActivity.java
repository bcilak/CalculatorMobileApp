...
public class MainActivity extends AppCompatActivity {
    ...
    public void operatorEvent (View view){
        ...
        switch (view.getId()){
            case R.id.button17: op ="/";break;
            case R.id.button19: op ="*";break;
            case R.id.button21: op ="+";break;
            case R.id.button22: op ="-";break;
            case R.id.button11: op ="sin";break;
            case R.id.button12: op ="cos";break;
            case R.id.button13: op ="tan";break;
            case R.id.button14: op ="!";break;
    ...
    public void equalEvent(View view){
        ...
        switch (op){
            ...
            case "tan":
                ...
                break;
            case "!":
                sonuc = factorial(Integer.parseInt(eskisayi));
                break;
